...
class TeleportEngine(SharedMemoryMixin, ScannerMixin, MemAllocMixin, CaveBuilderMixin, ReaderMixin, TeleportMixin):
    ...
    OFF_PHYS_POS = 0x0A0  # vec4: posição atual capturada de [r13] no hook_e
    OFF_PHYS_PTR = 0x0C0  # uint64: endereço do vetor [r13] capturado pelo hook_e
    OFF_CA   = 0x100
    OFF_CB   = 0x180
    OFF_CC   = 0x200
    OFF_CD   = 0x280
